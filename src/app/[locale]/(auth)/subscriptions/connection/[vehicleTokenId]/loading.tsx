...
export default function ConnectionSubscriptionDetailLoading() {
  return (
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="w-full lg:w-3/4">
        ...
        {/* Connection Subscription Detail Card Skeleton */}
        <div className="flex flex-col justify-between bg-surface-default rounded-2xl py-3">
          <div className="space-y-4">
            ...
            {/* Connection Date Section */}
            <div className="px-4">
              <SkeletonBox className="w-28 h-3 mb-1" />
              <div className="pb-3 border-b border-gray-700">
